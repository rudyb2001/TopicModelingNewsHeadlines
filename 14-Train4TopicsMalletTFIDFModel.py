...
lda_model_4topics_mallet_tfidf = gensim.models.wrappers.LdaMallet(mallet_path, corpus=corpus_tfidf, num_topics=4, id2word=dictionary)

lda_model_4topics_mallet_tfidf.save('./pickle/lda_model_4topics_mallet_tfidf')
